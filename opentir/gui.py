...
class OpenTIRApp(ctk.CTk):
    ...
    def _draw_lens_fills(self, ax):
        ...
        for f_pts, r_pts, color in self._lens_fill_data:
            ...
            fill_front = ax.fill(upper_z, upper_r, color=color, alpha=LENS_FILL_ALPHA, zorder=1, label="Fronte lente")
            fill_back = ax.fill(upper_z, -upper_r, color=color, alpha=LENS_FILL_ALPHA, zorder=1, label="Retro lente")
